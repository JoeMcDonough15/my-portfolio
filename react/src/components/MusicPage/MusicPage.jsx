    ...
    <>
      ...
      <section className="main-container col music-bio-text">
        <p className="text-block">
          ...
          on their 2018 Grammy winning album, Bringin’ It. As a sideman with
          other groups, I have been featured with the Boston Symphony Pops
        ...
        <p className="text-block">
          ...
          a member of the city’s preeminent jazz orchestra, I had the privilege
          of performing with such jazz luminaries as Jimmy Heath, Clark Terry,
          Benny Golson, Randy Brecker, Jon Faddis Wynton Marsalis, and Kenny
          Barron.
        </p>
        <p className="text-block">
          As an educator, I have served on the faculty of Temple University’s
          Boyer College of Music and Dance. I have also conducted educational
          workshops with Jazz at Lincoln Center and The Juilliard School, my
          second alma mater.
        </p>
      </section>
      <MusicGallery />
